---
# This repository is for version 2.x of @ngrx/store that uses ng-metadata
# [Click here for the original version](https://github.com/ngrx/store)
# [Click here for the latest version (4.x)](https://github.com/ngrx/platform)
---

## @ngrx/store
RxJS powered state management for AngularJS - NG-metadata applications, inspired by Redux
